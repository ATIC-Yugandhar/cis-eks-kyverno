...
```
\n---\n
\n## Test: `tests/kubernetes/custom-3.2.2/compliant/kyverno-test.yaml`
\n```
Loading test  ( tests/kubernetes/custom-3.2.2/compliant/kyverno-test.yaml ) ...
  Loading values/variables ...
  Loading policies ...
  Loading resources ...
  Loading exceptions ...
...
```
\n---\n
\n## Test: `tests/kubernetes/custom-3.2.2/noncompliant/kyverno-test.yaml`
\n```
Loading test  ( tests/kubernetes/custom-3.2.2/noncompliant/kyverno-test.yaml ) ...
  Loading values/variables ...
  Loading policies ...
  Loading resources ...
  Loading exceptions ...
...
WARNING: test file (tests/kubernetes/custom-3.2.6/compliant/kyverno-test.yaml) uses a deprecated schema that will be removed in 1.14
...
WARNING: test file (tests/kubernetes/custom-3.2.6/noncompliant/kyverno-test.yaml) uses a deprecated schema that will be removed in 1.14
...
```
\n---\n
\n## Test: `tests/kubernetes/custom-5.1.3/compliant/kyverno-test.yaml`
\n```
Loading test  ( tests/kubernetes/custom-5.1.3/compliant/kyverno-test.yaml ) ...
  Loading values/variables ...
  Loading policies ...
  Loading resources ...
  Loading exceptions ...
...
```
\n---\n
\n## Test: `tests/kubernetes/custom-5.1.3/noncompliant/kyverno-test.yaml`
\n```
Loading test  ( tests/kubernetes/custom-5.1.3/noncompliant/kyverno-test.yaml ) ...
  Loading values/variables ...
  Loading policies ...
  Loading resources ...
  Loading exceptions ...
